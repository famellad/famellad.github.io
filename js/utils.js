/**
 * Checkes whether the user is running a mobile browser
 */
...
/**
 * Removes special characters from a string and returns it as lowercase
 * @param {string} inStr
 */
...
/**
 * Returns the file on the specified URI as an unformatted one-lined string
 * If it fails, it returns an empty string and logs an error message
 * @param {string} fileURI
 */ 
